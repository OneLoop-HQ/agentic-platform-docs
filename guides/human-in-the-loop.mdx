---
title: "Human-in-the-Loop: Approvals and Assistant Handoffs"
sidebarTitle: "Human-in-Loop"
description: "Pause assistant conversations for human approval, hand off to a live operator, and relay messages back to end users — using Feather's HITL API."
---
...
<Steps>
  ...
  <Step title="Fetch full approval detail">
    ...
    **ApprovalRequestDetail fields:**
    ...
    | `payload` | object | The full action payload the assistant intends to execute |
  ...
  <Step title="Review the handoff context">
    ...
    ```json
    {
      ...
      "packet": {
        ...
        "reason": "Issue requires access to billing backend — outside assistant permissions.",
    ...
    | `reason` | Why the assistant decided to escalate. |
