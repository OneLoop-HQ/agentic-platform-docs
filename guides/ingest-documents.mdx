...
| Field | Description |
|---|---|
| `status` | `queued` · `processing` → terminal `completed` · `partial_failure` · `failed` · `duplicate` · `quarantined` |
...
| `score` | Relevance score (hybrid dense/sparse). Higher is more relevant; not a normalized 0–1 cosine |
...
<Card title="Knowledge Base API Reference" icon="book" href="/api-reference/knowledge-base/create-a-knowledge-base">
